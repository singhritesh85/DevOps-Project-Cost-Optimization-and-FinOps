...
yum -y install dnf-plugins-core vim zip unzip git wget java-17*
...
echo "export PATH=\"\$PATH:\$(dirname \"\$(readlink -f \"\$(which java)\")\")/bin:/opt/apache-maven/bin:/opt/node-v16.0.0/bin:/opt/dependency-check/bin\"" >> /etc/profile.d/java.sh
